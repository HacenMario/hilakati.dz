...
// ============================================================
// ⏰ نظام تذكير واتساب (قبل 24 ساعة من الحجز)
// ============================================================
const cron = require('node-cron');
const axios = require('axios');

// تشغيل المجدول كل ساعة
cron.schedule('0 * * * *', async () => {
    ...
    if (!apiUrl || !idInstance || !apiToken) {
        console.warn('⚠️ متغيرات واتساب غير مضبوطة، تخطي التذكيرات');
        return;
    }
    ...
    try {
        ...
        console.log(`📅 عدد الحجوزات التي تحتاج تذكير واتساب: ${appointments.length}`);
